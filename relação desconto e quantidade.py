...
sns.scatterplot(data=dados, x='Desconto', y='Quantidade', hue='Categoria', palette='coolwarm', alpha=0.6)
sns.regplot(data=dados, x='Desconto', y='Quantidade', scatter=False, color='red', ci=None, line_kws={"linestyle": "--"})
